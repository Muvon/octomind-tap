...
link "memory-read" "octobrain.toml"
link "memory-write" "octobrain.toml"
link "websearch" "duckduckgo.toml"
...
link "music" "elevenlabs-music.toml"
...
link "publish-x" "xdevplatform.toml"
