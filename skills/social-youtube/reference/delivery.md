...
Open this reference before preparing assets, optional formats, commercial disclosures, or monetization-dependent copy. Check the actual account and destination surface. Availability checks below are publishing instructions, not claims of universal feature access.

## Asset and format gate
...
|---|---|---|
| Live stream | Concrete demonstration plan, moderator brief, objection queue, failure fallback and replay title | Access, scheduled destination, disclosure controls and ad interruptions |
| Premiere | Finished film, discussion purpose, host availability and replay description | Scheduling and actual audience interaction controls; don't imply a live demonstration |
| Channel posts and polls | Useful update or decision-relevant prompt with clear options | Current composer, attachment support and visibility |
| Communities | Participation prompts grounded in the channel's subject | Account access, posting permissions and moderation controls |
| Podcast | Complete episode promise, guest context, source notes and accessible transcript | Podcast designation and current listening surfaces; separate excerpts from complete episodes |
| Members-only | Clearly named member benefit and access conditions | Visibility and destination access; don't route nonmembers into an unexplained paywall |
| Clips and remix tools | Self-contained excerpt preserving the original claim and limitation | Tool availability, reuse rights, source attribution and an accessible full-context route |
| Creator collaboration | Shared viewer problem, distinct contribution and commercial relationship | Creator approval, permissions and any available collaboration or brand-linking controls |
...
Separate announced future requirements from current eligibility. Beginning February 1, 2027, ongoing Shorts ads and subscription revenue sharing requires 10 million qualified Shorts views in the preceding 90 days; falling below leaves YPP membership and long-form earnings intact (official, YouTube YPP announcement, 2026-08). New applicants then need 8,000 qualified watch hours in 365 days or 20 million qualified Shorts views in 90 days for ads and Premium sharing; fan-funding and Shopping entry thresholds remain unchanged (official, YouTube YPP announcement, 2026-08). Use these only for a forecast spanning that effective date.
...
- [YPP announcement](https://blog.youtube/news-and-events/youtube-partner-program-updates-2027-new-opportunities-earn/), 2026-08-10.

Re-validate when:
- Upload controls, optional formats, language support or disclosure tooling change.
- Advertiser rules or announced monetization requirements change or take effect.
